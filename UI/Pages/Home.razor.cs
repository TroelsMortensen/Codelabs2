                ...
                new Course("PRO1", "#7FFFD4",
                    [
                        new Session(1, "Basic Java",
                            [
                                new LearningPath("Introduction", "PRO1/Session 1 Learning Path"),
                                new LearningPath("Default Values", "PRO1/Session 2 Default Values"),
                            ]
                        ),
                        new Session(2, "Input",
                            [
                        ...
                        new Session(3, "If-statement",
                            [
                                new LearningPath("Boolean logic recap", "PRO1/Session 3 Boolean logic"),
                                new LearningPath("The if-statement", "PRO1/Session 3 If statement"),
                                new LearningPath("Extra exercises", "PRO1/Session 3 - live"),
                            ]
                        ),
                        ...
                        new Session(5, "Loops",
                            [
                                new("Increment and decrement", "PRO1/Session 5 Inc and Dec"),
                                new("For-loop", "PRO1/Session 5 For loop"),
                                new("While-loop", "PRO1/Session 5 While loop"),
                            ]
                        ),
                        ...
                        new Session(8, "Introducing Objects",
                            [
                                new("Objects", "PRO1/Session 8 Objects"),
                                new("UML", "PRO1/Session 8 UML"),
                                new("Encapsulation", "PRO1/Session 8 Encapsulation"),
                                new("Shadowing", "PRO1/Session 8 Shadowing"),
                            ]
                        ),
                        new Session(9, "More about Objects",
                            [
                                new("Inheriting from Object", "PRO1/Session 9 Inherit from Object"),
                                new("Final keyword", "PRO1/Session 9 Final fields"),
                                new("Static keyword", "PRO1/Session 9 Static"),
                                new("Overloading methods", "PRO1/Session 9 Method overloading"),
                                new("Extra exercises", "PRO1/Session 9 - Extra exercises")
                            ]
                        ),
                        new Session(10, "Object exercises",
                            [
                                new("Garbage collection in Java", "PRO1/Session 10 - Garbage collection"),
                                new("Extra exercises", "PRO1/Session 10 - Exercises")
                            ]
                        ),
                        new Session(11, "Relationships part 1",
                            [
                                new("Relations between objects", "PRO1/Session 11 - Relationships intro")
                            ]
                        ),
                        new Session(12, "Relationships part 2",
                            [
                                new("One to many relationships", "PRO1/Session 12 - One to Many")
                            ]
                        ),
                        new Session(13, "Inheritance part 1",
                            [
                                new("Introducing Inheritance", "PRO1/Session 13 - Inheritance")
                            ]
                        ),
                        new Session(14, "Abstract classes",
                            [
                                new("Abstract keyword", "PRO1/Session 14 - Abstract"),
                                new("Polymorphism", "PRO1/Session 14 - Polymorphism")
                            ]
                        ),
                        new Session(15, "Interfaces",
                            [
                                new("Packages", "PRO1/Session 15 - Packages"),
                                new("Interfaces", "PRO1/Session 15 - Interfaces")
                            ]
                        ),
                        new Session(16, "Exercises",
                            [
                                new("Extra exercises", "PRO1/Session 16 - Test")
                            ]
                        ),
                        new Session(17, "Exceptions",
                            [
                                new("Exceptions", "PRO1/Session 17 - Exceptions")
                            ]
                        ),
                        ...
                        new Session(19, "Introducing files",
                            [
                                new("File I/O", "PRO1/Session 19 - File IO"),
                            ]
                        ),
                        ...
                        new Session(22, "JavaFX - multiple views",
                            [
                                new("JavaFX - Multiple views", "PRO1/Session 22 - JFX Continued")
                            ]
                        ),
                        new Session(23, "JavaFX - Application",
                            [
                                new("JavaFX - application design", "PRO1/Session 23 - JFX Application")
                            ]
                        ),
                        new Session(24, "Exam",
                            [
